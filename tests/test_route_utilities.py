...
def test_get_models_with_two_filters_matching_book(two_saved_books):
    # Act
    result = get_models_with_filters(Book, {"title": "ocean", "description": "watr 4evr"})
...
def test_get_models_with_two_filters_no_matching_book(two_saved_books):
    # Act
    result = get_models_with_filters(Book, {"title": "ocean", "description": "no_matiching"})
